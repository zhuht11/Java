...
public class hahaha {
	...
	public static void main(String[] args) 
	{
		...
		System.out.println("(0 - single filer, 1-married jointly or " + "qualifing widow(er), 2-married separately, 3-head of " + " + household) \nEnter the filing status: ");
		...
		else if(status == 3)
		{
			if(income <= 11950)
				...
				tax = 11950 * 0.10 + (45500 - 11950) * 0.15 + (117450 - 45500) * 0.25 + (186475 - 117450) * 0.28 + (income - 186475) * 0.33;
			else 
				tax = 11950 * 0.10 + (45500 - 11950) * 0.15 + (117450 - 45500) * 0.25 + (186475 - 117450) * 0.28 + (372950 - 186475) * 0.33 + (income - 372950) * 0.35;
		}
		else
		{
